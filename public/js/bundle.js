...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"showAlert.js":[function(require,module,exports) {
"use strict";
...
function showAlert(message, state) {
  ...
  div.className = "alert alert--".concat(state);
...
exports.updateInfo = exports.updatePassword = exports.signup = exports.logout = exports.login = void 0;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, password) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _showAlert.showAlert)('Successfully logged in.', 'success');
          ...
          case 7:
            ...
            (0, _showAlert.showAlert)(_context.t0.response.data.message, 'fail');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _showAlert.showAlert)(_context2.t0.response, 'fail');
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(name, password, passwordConfirm, email) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _showAlert.showAlert)('Successfuly signed up.', 'success');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
          ...
          case 8:
            ...
            (0, _showAlert.showAlert)(_context3.t0.response, 'fail');
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee4(currentPassword, newPassword, confirmPassword) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _showAlert.showAlert)('Successfully updated your password.', 'success');
              setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
          ...
          case 8:
            ...
            (0, _showAlert.showAlert)(_context4.t0.response.data.message, 'fail');
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee5(name, email) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _showAlert.showAlert)('Successfully updated your info.', 'success');
              setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
          ...
          case 8:
            ...
            (0, _showAlert.showAlert)(_context5.t0.response.data.message, 'fail');
  ...
  return function updateInfo(_x10, _x11) {
    return _ref5.apply(this, arguments);
  };
}();

exports.updateInfo = updateInfo;
},{"axios":"../../node_modules/axios/index.js","./showAlert":"showAlert.js"}],"todos.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editTodo = exports.deleteTodo = exports.addTodo = void 0;
...
var addTodoUI = function addTodoUI(id, n, d, t, p) {
  ...
  priority.className = "tl__priority tl__priority--".concat(p);
  var divider = "<div class='divider divider--vertical'></div>";
  ...
  actions.className = 'actions'; // const edit = document.createElement('button');
...
var editTodoUI = function editTodoUI(id, data) {
  var tlContainer = document.getElementById(id);
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, description, time, priority) {
    var resTodo;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            resTodo = _context.sent;

            if (resTodo.data.status === 'success') {
              (0, _showAlert.showAlert)('Successfully added.', 'success');
  ...
  return function addTodo(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _showAlert.showAlert)('Successfully deleted.', 'success');
              removeTodo(id);
            }
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _showAlert.showAlert)(_context2.t0.response.data.message, 'fail');
...
function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _showAlert.showAlert)('Successfully edited.', 'success');
              editTodoUI(id, data);
            }
          ...
          case 7:
            _context3.prev = 7;
            _context3.t0 = _context3["catch"](0);
            (0, _showAlert.showAlert)(_context3.t0.response.data.message, 'fail');
  ...
  return function editTodo(_x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}();

exports.editTodo = editTodo;
},{"axios":"../../node_modules/axios/index.js","./showAlert":"showAlert.js"}],"sendMessage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendMultiple = exports.sendSingle = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(id, title, message) {
    var resMessage, resUser;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 7:
            ...
            if (resUser.data.status === 'success') {
              console.log(resUser);
              (0, _showAlert.showAlert)("Successfully sent a message to ".concat(resUser.data.data.data.name), 'success');
            }
  ...
  return function sendSingle(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(title, message) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _showAlert.showAlert)('Successfully sent a message to everyone.', 'success');
            }
  ...
  return function sendMultiple(_x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();

exports.sendMultiple = sendMultiple;
},{"axios":"../../node_modules/axios/index.js","./showAlert":"showAlert.js"}],"user.js":[function(require,module,exports) {
"use strict";
...
var editRoleUI = function editRoleUI(id, role) {
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(id, role) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _showAlert.showAlert)('Successfully edited the user.', 'success');
              editRoleUI(id, role);
            }
  ...
  return function editRole(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.editRole = editRole;
},{"axios":"../../node_modules/axios/index.js","./showAlert":"showAlert.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var ltForm = document.querySelector('.form--lt');
var deleteButton = document.querySelectorAll('.delete-todo');
var editButton = document.querySelectorAll('.edit-todo');
var name = document.getElementById('name');
var description = document.getElementById('description');
var time = document.getElementById('time');
var title = document.getElementById('title');
var message = document.getElementById('message');
var singleButton = document.querySelectorAll('.message-single');
var multipleButton = document.getElementById('message-multiple');
var editUserButton = document.querySelectorAll('.edit-user');
var editUserRoleButton = document.getElementById('edit-user-role');
...
var updatePasswordButton = document.getElementById('password');
var updateDetailButton = document.getElementById('detail');
var userID;
...
if (updatePasswordButton) {
  updatePasswordButton.addEventListener('click', function (e) {
    ...
    if (currentPassword.value === '' || newPassword.value === '' || confirmPassword.value === '') {
      (0, _showAlert.showAlert)('Please fill out the values.', 'fail');
    } else {
      (0, _account.updatePassword)(currentPassword.value, newPassword.value, confirmPassword.value);
    }
  });
}

if (updateDetailButton) {
  updateDetailButton.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _account.updateInfo)(username.value, email.value);
  });
}

if (editUserButton) {
  editUserButton.forEach(function (el) {
...
if (editUserRoleButton) {
  editUserRoleButton.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _user.editRole)(userID, role.value);
  });
}

if (singleButton) {
  singleButton.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      (0, _sendMessage.sendSingle)(e.target.parentElement.parentElement.id, title.value, message.value);
    });
  });
}
...
if (multipleButton) {
  multipleButton.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _sendMessage.sendMultiple)(title.value, message.value);
  });
}
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _account.login)(name, password);
  });
}
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _account.signup)(name, password, passwordConfirm, email);
  });
}
...
if (deleteButton) {
  deleteButton.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      (0, _todos.deleteTodo)(e.target.parentElement.parentElement.id);
    });
  });
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1607" + '/');
